...
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `gtfs.yml`                   | Mon, Thu 16:30 CET (after the 15:00 RT switch)                                                                            | 248 MB zip, ≈ 3 min streaming; BAV XTF + SBB lines → stitched graph, ≈ 40 s | `rail/{meta,stops,routes,patterns,distances}.json`, `rail/days/YYYYMMDD.json` (≈ 4.5 MB, ≈ 21 k trips), `rail/paths/{pathId}.json` (one per unique stop sequence, 20 m simplified, 9 k files / 41 MB) → workflow artifact and the orphan branch `rail-data`, served by GitHub Pages; the web reads `RAIL_DATA_URL` or `public/rail/` |
