...
| Choreographed time-based sequences: "Switzerland Today", explainers, replayable stories, MP4s for Shorts/Reels/TikTok                 | **Remotion**                                                                                                 | `apps/video`                                  |
| A genuine time-based composition inside the website                                                                                   | **Remotion `<Player>`**, only on `/today`                                                                    | `apps/web/app/today`                          |
