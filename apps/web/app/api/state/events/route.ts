...
import { EVENTS_TTL_SECONDS, getEventsState } from "@/lib/state/events";
import { cacheControl } from "@/lib/state/weather";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

/** EventsState: police and SRF headlines, geocoded with confidence. */
export async function GET(req: Request) {
  try {
    ...
    const headers = {
      "Cache-Control": cacheControl(EVENTS_TTL_SECONDS),
      ETag: etag,
